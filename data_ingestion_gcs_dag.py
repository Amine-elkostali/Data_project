...
# Specify our dataset
dataset_url = f"https://www.stats.govt.nz/assets/Uploads/Annual-enterprise-survey/Annual-enterprise-survey-2020-financial-year-provisional/Download-data/annual-enterprise-survey-2020-financial-year-provisional-csv.csv"
dataset_file = "finance.csv"
...
BIGQUERY_DATASET = os.environ.get("BIGQUERY_DATASET", 'Tesla_market')
